 ...
 */
public class BurpLFIPayloadMenu extends JMenu {
    ...
    public BurpLFIPayloadMenu(BurpExtender extender, IContextMenuInvocation invocation){
        try {
            this.setText("add [xss payload] on this");
            this.mExtender = extender;
            this.mInvocation = invocation;

            List<ConfigEntry> payload = extender.tableModel.getConfigByType(ConfigEntry.Config_LFI_Payload);
