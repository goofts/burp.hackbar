 ...
 */
public class RobotInputUtils extends Robot {

    public RobotInputUtils() throws AWTException {
        super();
    ...
    public void inputString(String str){
        ...
        if (CustomUtils.isWindows10()) {//粘贴的不同实现方式
            inputWithCtrl(KeyEvent.VK_V);
        }else if (CustomUtils.isWindows()) {
